...
<section class="call-to-action white-bg">
    <div class="el-container">
        <div class="call-to-action-wrapper">
            <?php
            $encrypted_cta_cat = $encrypted_et_to['call_to_action_category'];
            $encrypted_cta_num = $encrypted_et_to['enter_number_of_item_show_call_to_action'];
            $encrypted_cta_read_more = $encrypted_et_to['read_more_text'];
            ?>
            <div class="call-to-action-title wow bounceInLeft animated" data-wow-delay="0.5s"><?php echo get_cat_name($encrypted_cta_cat); ?></div>
            <ul>
            <?php
            $encrypted_cta_args = array('cat' => $encrypted_cta_cat, 'post_type' => 'post', 'post_status' => 'publish', 'posts_per_page' => -1);
            $encrypted_cta_query = new WP_Query($encrypted_cta_args);
            if ($encrypted_cta_query->have_posts() && !empty($encrypted_cta_cat)):
                while ($encrypted_cta_query->have_posts()): $encrypted_cta_query->the_post();
            ?>
            <li><div class="call-to-action-desc wow bounceInLeft animated" data-wow-delay="0.4s"><a href="<?php the_permalink(); ?>"><sub>(<?php echo get_the_date('d M, Y'); ?>)</sub> <?php echo $post->post_title; ?></a></div></li>
                            ...
                            while ($encrypted_query_fp->have_posts()): $encrypted_query_fp->the_post();
                                ...
                                <div class="feature feature<?php $encrypted_count ?>">
                                    <?php if (has_post_thumbnail()):
                                        ...
                                        <a href="<?php the_permalink(); ?>">
                                            <div class="feature-circle">
                                                <img src="<?php echo $encrypted_image[0]; ?>"
                                                     alt="<?php the_title(); ?>"/>
                                    ...
                                    <div class="feature_content_wrap">
                                        <a href="<?php the_permalink(); ?>">
                                            <div class="feature-number"><h2><?php the_title(); ?></h2></div>
                                        </a>

                                        <div
                                            class="feature-text"><?php echo encrypted_lite_excerpt(get_the_content(), $encrypted_feature_page_char, true); ?> </div>
                                    </div>
                                </div>
                                <?php
                            endwhile;
    ...
    <section class="portfolio encrypted-section white-bg wow fadeInUp animated" data-wow-delay="0.5s">
        <div class="el-container">
            <h2><span class="line"> </span>
                ...
                <div class="feature-layout-title"><span><?php echo $encrypted_et_to['portfolio_section_title'] ?></span>
                </div>
            </h2>
                ...
                if ($encrypted_testi_query->have_posts() && !empty($encrypted_testi_cat)):
                    while ($encrypted_testi_query->have_posts()):$encrypted_testi_query->the_post();
                        ...
                        <div class="testimonial-main-wrap">
                            <div
                                class="team-content"><?php echo encrypted_lite_excerpt(get_the_content(), $encrypted_testi_char, true); ?></div>
                            <div class="tm-img">
                                <a href="<?php the_permalink(); ?>"><img src="<?php echo $encrypted_image[0]; ?>"
                                                                         alt="<?php the_title(); ?>"/></a>
                            </div>
                            ...
                            <figure class="team_member_image">
                                ...
                                <div class="team_detail">
                                    ...
                                    <div class="team_conten_hover">
                                        <div
                                            class="team_member_content"><?php echo encrypted_lite_excerpt(get_the_content(), $encrypted_team_char, true) ?></div>
                                    </div>
                                </div>
                            </figure>
                        </div>
            ...
            <div class="address wow shake animated" data-wow-delay="0.8s">
                <div class="adddress-wrap">
                    ...
                    <div class="contact-info">
                        <div class="contact-wrap"><i
                                class="fa fa-map-marker"></i><span><?php echo esc_attr($encrypted_address) ?></span>
                        </div>
                        <div class="contact-wrap"><i
                                class="fa fa-phone"></i><span><?php echo esc_attr($encrypted_phone) ?></span></div>
                        <div class="contact-wrap"><i
                                class="fa fa-envelope"></i><span><?php echo esc_attr($encrypted_email) ?></span></div>
                    </div>
                </div>
            </div>
        </div>
